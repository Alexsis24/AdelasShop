...
<main>
    <div class="container">
        ...
        <div class="row g-0">
            ...
            <div class="portfolio-container gx-1 gy-4">

                <!--Digital-->
                <div class="picture col-md-6 col-lg-4 col-xl-3 p-2 digital">
                    <div class="lightbox">
                ...
                <!--Drawings-->
                <div class = "picture col-md-6 col-lg-4 col-xl-3 p-2 drawings">
                    <div class = "collection-img position-relative">
                ...
                <!--Murals-->
                <div class="picture col-md-6 col-lg-4 col-xl-3 p-2 murals">
                    <div class="collection-img position-relative">
                ...
                <!--Paintings-->
                <div class="picture col-md-6 col-lg-4 col-xl-3 p-2 paintings">
                    <div class="collection-img position-relative">
                ...
                <!--Pins-->
                <div class="picture col-md-6 col-lg-4 col-xl-3 p-2 pins">
                    <div class="collection-img position-relative">
                ...
                <!--Stickers-->
                <div class="picture col-md-6 col-lg-4 col-xl-3 p-2 stickers">
                    <div class="collection-img position-relative">
